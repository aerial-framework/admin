package controllers
{
	...
	public class GenerationControllerOld
	{		
		private static var _instance:GenerationControllerOld;
		...
		{
			_instance = new GenerationControllerOld();
		}
		
		public function GenerationControllerOld()
		{
			if(_instance)
			{
		...
		private function setOptions(packageStr:String, boostrapFile:String, phpModelsFolder:File, as3ModelsFolder:File,
											phpServicesFolder:File, as3ServicesFolder:File, voSuffix:String, serviceSuffix:String):void
		{
		...
		public static function get instance():GenerationControllerOld
		{
			return _instance;
		}
